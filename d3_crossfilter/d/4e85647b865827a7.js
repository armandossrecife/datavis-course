...
dateDim.group().reduceSum(d => d.facebook)
  ...
  main.variable(observer("firstFacebook")).define("firstFacebook", ["dateDim"], function(dateDim){return(
dateDim.bottom(1)[0].facebook
)});
  main.variable(observer("firstGoogle")).define("firstGoogle", ["dateDim"], function(dateDim){return(
dateDim.bottom(1)[0].google
)});
  main.variable(observer("googleByDayGroup2")).define("googleByDayGroup2", ["dateDim","firstGoogle"], function(dateDim,firstGoogle){return(
dateDim.group().reduceSum(function(d) {
            return ((d.google - firstGoogle) / firstGoogle) * 100;
          })
)});
  main.variable(observer("fbByDayGroup2")).define("fbByDayGroup2", ["dateDim","firstFacebook"], function(dateDim,firstFacebook){return(
dateDim.group().reduceSum(function(d) {
  ...
  main.variable(observer("acoes")).define("acoes", ["md","container","dc","d3","dateDim","googleByDayGroup2","fbByDayGroup2"], function(md,container,dc,d3,dateDim,googleByDayGroup2,fbByDayGroup2)
{
  ...
  main.variable(observer("data_movies")).define("data_movies", ["d3"], function(d3){return(
d3.json("https://raw.githubusercontent.com/scientific-visualization/testes/master/movies.json").then(function(data){
  return data;
})
)});
  main.variable(observer("by_year")).define("by_year", ["crossfilter","data_movies","md","container","dc","d3"], function(crossfilter,data_movies,md,container,dc,d3)
{
let factsMovies = crossfilter(data_movies)
  ...
  main.variable(observer("by_genre")).define("by_genre", ["crossfilter","data_movies","md","container","dc","d3","width"], function(crossfilter,data_movies,md,container,dc,d3,width)
{
  let factsMovies = crossfilter(data_movies)
...
`
  ...
  main.variable(observer("chart")).define("chart", ["dc"], function(dc){return(
dc.barChart("#test")
)});
  main.variable(observer()).define(["d3","crossfilter","chart","dc"], function(d3,crossfilter,chart,dc){return(
