  ...
  main.variable(observer("map")).define("map", ["buildvis","L"], function(buildvis,L)
{
 ...
 Map tiles by &copy; <a href="https://carto.com/attribution">CARTO</a>`,
  ...
  main.variable(observer("geojson")).define("geojson", ["d3","blues","homicidesByName","L","info","map","bairros","style"], function(d3,blues,homicidesByName,L,info,map,bairros,style)
{
    ...
    // get color depending on number of cases
	  let quantize = d3.scaleQuantize()
		...
		layer.setStyle({
          ...
          dashArray: '3',
					fillOpacity: 0.6,
					fillColor: function(d) {quantize(homicidesByName.get(d.Bairro))	}
    });
